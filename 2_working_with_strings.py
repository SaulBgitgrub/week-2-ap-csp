...
print("Lowercase:", name.lower())  # Output: marvin
print("Lowercase:", phrase2.lower())  # Output: supercageisfragislistcious

# # Convert all characters to uppercase
print("Uppercase:", phrase.upper())  # Output: PYTHON IS FUN!
print("Uppercase:", name.upper())  # Output: MARVIN
print("Uppercase:", phrase2.upper())  # Output: SUPERCAGEFRAGISLISTCIOUS

# # Check if all characters are uppercase
print("Is Uppercase?", phrase.isupper())  # Output: False
print("Is Uppercase?", phrase2.isupper())  # Output: True
print("Is Uppercase?", name.isupper())  # Output:Free
